program center_grafic
   ...
   character*80::input,output,x,y,z
   ...
   CALL get_command_argument(3,x)
   CALL get_command_argument(4,y)
   CALL get_command_argument(5,z)
   ...
   write(*,*)'New center coordinates are :',xc1,xc2,xc3
!   read(*,*) xc1,xc2,xc3
